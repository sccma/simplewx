		...
		<div class="skin-2__content main">
			<?php  if(!defined('IN_MESSAGE')) { ?>
				...
				<div class="skin-2__container container">
						<div class="content <?php  if(!empty($_W['page']['title']) && !empty($_GPC['iscontroller'])) { ?>is-main-page<?php  } ?>">
						...
						<?php  if($frames['dimension'] == 2) { ?>
							...
							<ul class="we7-page-tab">
								...
								<?php  if(is_array($frames['section'][FRAME]['menu'])) { foreach($frames['section'][FRAME]['menu'] as $menu_id => $menu) { ?>
									...
									<li class="<?php  if($menu['active']) { ?>active<?php  } ?>"><a href="<?php  echo $menu['url'];?>&iscontroller=1"><?php  echo $menu['title'];?></a></li>
									<?php  } ?>
									<?php  } else { ?>
									<li class="<?php  if($menu['active']) { ?>active<?php  } ?>">
										<a href="<?php  echo $menu['url'];?>&iscontroller=1">
											<?php  echo $menu['title'];?>
											<!-- start应用管理中未安装应用数量 -->
