	...
	<div class="clearfix ">
		<div class="search-box we7-margin-bottom" >
			...
			<select name="" id="" class="we7-margin-right">
				...
				<option data-url="<?php  echo filter_url('order:asc');?>" <?php  if($_GPC['order'] == 'asc') { ?> selected<?php  } ?>>创建时间正序</option>
				<option data-url="<?php  echo filter_url('order:endtime_asc');?>" <?php  if($_GPC['order'] == 'endtime_asc') { ?> selected<?php  } ?>>到期时间正序</option>
				<option data-url="<?php  echo filter_url('order:endtime_desc');?>" <?php  if($_GPC['order'] == 'endtime_desc') { ?> selected<?php  } ?>>到期时间倒序</option>
			</select>
			<select name="" id="" class="we7-margin-right">
