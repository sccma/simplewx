...
function module_local_dev($message_type = '') {
	...
	$api_whitelist = array(
		'c=cloud&a=newprocess&do=module_build', 		'c=module&a=group&do=save', 		'c=utility&a=group&do=get_module_group_detail_info', 		'c=module&a=group&do=del', 		'c=account&a=post&do=', 		'c=account&a=post&do=modules_tpl', 		'c=account&a=post-user&do=edit', 		'c=account&a=post-user&do=set_manager', 		'c=miniapp&a=manage&do=display', 		'c=utility&a=modules&do=modules', 		'c=user&a=edit&do=', 		'c=user&a=create&do=check_user_info', 		'c=utility&a=group&do=get_user_group_detail_info', 		'c=user&a=group&do=save', 	);
	...
	if (empty($local_module_cache)) {
		$local_module = pdo_get('modules', array('issystem' => '0', 'from' => 'local', 'createtime >' => 1632647471));
